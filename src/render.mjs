...
export function header(rel = "") {
  ...
  const wa = attr(waHref("Hi, I'd like a quote for a letterbox lock. My postal code is __."));
...
<header class="header">
  <div class="wrap nav">
    ...
    <div class="actions">
      ...
      <a class="btn green" data-wa data-ev="whatsapp" href="${wa}" rel="noopener noreferrer">WhatsApp</a>
    </div>
    <a class="btn order header-order" data-ev="order-nav" href="${order}" aria-label="Order or get a quote">🔒 Order</a>
...
<a class="floating" data-wa data-ev="whatsapp-float" href="${wa}" rel="noopener noreferrer" aria-label="WhatsApp us">WA</a>
<div class="sticky-mobile">
  <a data-tel data-ev="call" href="${tel}">Call</a>
  <a data-wa data-ev="whatsapp" href="${wa}" rel="noopener noreferrer">WhatsApp</a>
  <a class="sm-order" data-ev="order-nav" href="${order}">Order</a>
</div>
